...
```jsx
const App = () => (
  <div> // Is this a dom element=> Yes => Create a dom element
    <Component /> // Is this a dom element => No=> Call and evaluate the component the component
  </div>
)
```
...
const Component =()=> (
  <div> // Is this a dom element=> Yes => Create a dom element
    <p> // Is this a dom element=> Yes => Create a dom element
    <AnotherCustomComponent /> // // Is this a dom element => No=> Call and evaluate the component the component
    </p>
  </div>
)
```
...
Leaf components are low level components with most markup,while orchestraing components are orchestating the app, like toggles
...
11. React calls our render update method a second time
